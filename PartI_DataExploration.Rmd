...
cv1 <- cvFit(lm.fit, data=train.regression, y=train.regression$result.max, K = 2, seed=1)
#cv2 <- cvFit(lm.fit, data=train.regression, y=train.regression$result.max, K = 10, seed=1)
