...
combined_data_clean %>% drop_na("total_enrollment", "free_reducedmealprogram", "homeless", "migrantprogram", "direct_certification", "unduplicatedfrpm_eligible_count", "english_learner_el" , "result", "action_level_exceedance", "school_type.y")
...
combined_data_clean_grouped_rmna$english_learner_el =  combined_data_clean_grouped_rmna$english_learner_el /combined_data_clean_grouped_rmna$total_enrollment

combined_data_clean_grouped_rmna$calpads_unduplicated_pupil_countupc =  combined_data_clean_grouped_rmna$calpads_unduplicated_pupil_countupc /combined_data_clean_grouped_rmna$total_enrollment
...
ggplot(data=train)+
  geom_density(aes(english_learner_el))

ggplot(data=train)+
  geom_density(aes(calpads_unduplicated_pupil_countupc))
...
ggplot(data=train)+
  geom_bar(aes(school_type.x))+ theme(axis.text.x = element_text(angle = 45, hjust=1))
...
ggplot(data=train)+
  geom_violin(aes(x=school_type.x, y=log(result.max)))+ theme(axis.text.x = element_text(angle = 45, hjust=1))
